...
<div class="panel">
    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                <form action="{{route('user.store')}}" enctype="multipart/form-data" method="post" accept-charset="utf-8" autocomplete="off">
                    @csrf 
                    <div class="form-group row">
                        <label for="firstname" class="col-sm-3 col-form-label">First Name </label>
                        <div class="col-sm-9">
                            <input name="firstname" class="form-control" type="text" placeholder="First Name" id="firstname">
                        </div>
                    </div>
                 ...
                 <label for="istatus" class="col-sm-3 col-form-label">Is Monitor Display</label>
                     <div class="col-sm-9">
                     		<div class="checkbox checkbox-success">
                               <input type="checkbox" name="counter" value="1" id="counter">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <label class="radio-inline">
                                 <input type="radio" name="status" value="1" checked="checked" id="status" autocomplete="off">
                                 Active
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="status" value="0" id="status" autocomplete="off">InActive
                            </label> 
                        </div>
                    </div>
